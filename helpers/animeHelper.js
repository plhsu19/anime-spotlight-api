...
const mapFromKitsuAnimeToAnime = (kitsuAnime) => {
  ...
  data.rating =
    Math.round(Number.parseFloat(kitsuAnime.attributes.averageRating)) / 10;
  ...
  data.coverImage = kitsuAnime.attributes.coverImage
    ? kitsuAnime.attributes.coverImage.small
    : null;
...
module.exports.nonEmptyString = (value) => {
